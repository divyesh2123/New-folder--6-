 const myApiData = [
  ...
  const mydisplay = myApiData.map((valuee,index)=> {

    let myhtmlinner = valuee.Images.map((imgs,indexinner)=> {

        return (` 
        <button type="button" data-bs-target="#demo${index}" data-bs-slide-to="${indexinner}" class="active"></button>
    ...
    let myhtmlinnerimages = valuee.Images.map((myimages,indexinner1)=> {

        return (` 
       
        <div class="carousel-item active">
      <img src="${myimages}" alt="Los Angeles" class="d-block w-100">
    </div> 
  ...
  document.getElementById("display").innerHTML = mydisplay.join("");